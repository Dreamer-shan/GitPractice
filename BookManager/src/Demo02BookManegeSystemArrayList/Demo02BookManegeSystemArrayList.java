package Demo02BookManegeSystemArrayList;

import java.util.ArrayList;
import java.util.Scanner;

public class Demo02BookManegeSystemArrayList {
    /*
    ...
    int count = 0;
    public Demo02BookManegeSystemArrayList(){
        ...
        while (true){
            ...
            if (choice == 1){
                ...
                if (id > -1){
                    ...
                    booklist.remove(id); // ArrayList直接删除元素
                    count--;
...
//                    System.out.println("原书名为:" + booklist[id].getName() + "请输入你要修改成什么名字");
                    System.out.println("原书名为:" + book.getName() + "请输入你要修改成什么名字");
                    String str = sc.next();
                    System.out.println("请输入作者：");
                    String author = sc.next();
...
//                    System.out.println("你要查找的书名为:" + booklist[id].getName());
                    System.out.println("你要查找的书名为:" + book.getName());
                }
                else {
                    System.out.println("输入错误");
                }
    ...
    private void printAllBook() {
        ...
        for (int i = 0; i < count; i++) {
            Book book = (Book)booklist.get(i);
            System.out.println("第"+ (i + 1) + "本书名：" + book.getName()
            + " 作者:" + book.getAuthor() + " 单价：" + book.getPrice());
        }
    }

    public static void main(String[] args) {
        new Demo02BookManegeSystemArrayList();
    }
