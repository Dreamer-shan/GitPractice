...
public class Operator {
    ...
    public boolean changeBoo(int id,String bookname, String author, float price)
    {
        ...
        boolean flag = book.setBook(bookname,author,price);
    ...
    {
        Book book = (Book)BookList.booklist.get(id);
        System.out.println("查找成功，您查找到的书为第"+(id+1)+"本书！"+"书名为："+book.getName()+" 作者："+book.getAuthor()+" 单价："+book.getPrice()+"元/本");
    }
    ...
    public void printAllBook()
    {
        ...
        {
            Book book = (Book)BookList.booklist.get(i);
            System.out.println("第"+(i+1)+"本书名："+book.getName()+" 作者："+book.getAuthor()+" 单价："+book.getPrice()+"元/本");
        }
    }
}